...
{
    public class SiHunLingDeYuXi() : EWCard(2, CardType.Power, CardRarity.Rare, TargetType.None)
    {
        protected override string PortraitFileName => "PL4 01 si_hun_ling_de_yu_xi.png";
